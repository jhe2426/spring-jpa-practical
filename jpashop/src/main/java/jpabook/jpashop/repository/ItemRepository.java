    ...
    /*
        ...
        2. merge() 사용
            ...
            장점
                ...
                - 수정된 값들을 이미 가지고 있는 엔티티가 완성되어 있다면 각 필드를 직접 하나씩 영속 엔티티에 옮기지 않고 merge() 한 번으로 상태를 병합할 수 있어 코드가 간단해질 수 있다.
            ...
            예)
                ...
                예)
                    ...
                    즉 하나의 영속성 컨텍스트 안에서는 id = 1 → 하나의 Item 인스턴스 만 존재하도록 관리해야 한다.
